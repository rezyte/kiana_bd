...
window.onload = function() {
  ...
  var messages = [
    ...
    '۲۱ سالگیت رو با بهترین ها شروع کن و برای<br>چیز هایی که دوست داری درست عین<br> کسایی که دوست داری بجنگ، بترکون تو دختر <br> فوق العاده ای هستی، خدا خیلی دوست داره <br> شایسته بهترین ها هستی',
    'دلم میخواد همه تولدای بعدیتو کنارت، شادی تو ببینم<br>دوست دارم از ته قلبم برات بریزم بیرون<br>هر چی اون تو هست تا شاد باشی<br>تا تولدت و بقیه روزهای زندگیت رو <br> با اون لبخند های باحالت بگذرونم',
